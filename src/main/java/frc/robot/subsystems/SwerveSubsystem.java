...
public class SwerveSubsystem extends SubsystemBase {
    ...
    private final static Pigeon2 gyro = new Pigeon2(20);
    ...
    public void resetOdometry(Pose2d pose) {
        SwerveModulePosition[] moduleStates = {frontLeft.getPosition(), frontRight.getPosition(), backLeft.getPosition(), backRight.getPosition()};
        odometer.resetPosition(getRotation2d(), moduleStates, pose);
    }
    ...
    public void periodic(){
        //SwerveModulePosition[] moduleStates = {frontLeft.getState(), frontRight.getState(), backLeft.getState(), backRight.getState()};
